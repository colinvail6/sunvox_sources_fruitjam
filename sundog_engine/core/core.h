...
//FRUITJAM: COLOR16BITS + RGB565 + FRUITJAM + FRAMEBUFFER [ + SMALLMEMORY / SMALLCACHE ]
...
//FRUITJAM: ARCH_ARM, FRUITJAM, COLOR16BITS, RGB565, FRAMEBUFFER, SMALLMEMORY

#ifdef FRUITJAM
    #define COLOR16BITS	//matches the HSTX DVI driver's RGB565 pixel format
    #define RGB565
    #define FRAMEBUFFER
